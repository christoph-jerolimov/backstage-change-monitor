# Backstage Release 1.54.9

## Compared to 1.54.8 (previous patch release)

0 added, 0 removed, 1 upgraded, 209 unchanged.

### Version bumps

| Package | 1.54.8 | 1.54.9 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-techdocs-node` | 1.15.5 | 1.15.6 | Patch |
...
| `@backstage/plugin-techdocs-node` | 1.15.3 | 1.15.6 | Patch |
...
| `@backstage/plugin-techdocs-node` | 1.15.2 | 1.15.6 | Patch |
