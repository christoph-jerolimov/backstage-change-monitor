# Backstage Release 1.54.7

## Compared to 1.54.6 (previous patch release)

0 added, 0 removed, 1 upgraded, 209 unchanged.

### Version bumps

| Package | 1.54.6 | 1.54.7 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-auth-node` | 0.7.4 | 0.7.5 | Patch |

## Compared to 1.54.0 (first release of this minor)

0 added, 0 removed, 26 upgraded, 184 unchanged.

### Version bumps

| Package | 1.54.0 | 1.54.7 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-techdocs-backend` | 2.2.3 | 2.2.4 | Patch |
| `@backstage/plugin-techdocs-node` | 1.15.3 | 1.15.4 | Patch |
...
| `@backstage/plugin-techdocs-backend` | 2.2.2 | 2.2.4 | Patch |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.1.38 | 1.1.39 | Patch |
| `@backstage/plugin-techdocs-node` | 1.15.2 | 1.15.4 | Patch |
