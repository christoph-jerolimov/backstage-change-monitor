# Backstage Release 1.54.8

## Compared to 1.54.7 (previous patch release)

0 added, 0 removed, 3 upgraded, 207 unchanged.

### Version bumps

| Package | 1.54.7 | 1.54.8 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.3.7 | 0.3.8 | Patch |
| `@backstage/plugin-techdocs-backend` | 2.2.4 | 2.2.5 | Patch |
| `@backstage/plugin-techdocs-node` | 1.15.4 | 1.15.5 | Patch |

## Compared to 1.54.0 (first release of this minor)

0 added, 0 removed, 27 upgraded, 183 unchanged.

### Version bumps

| Package | 1.54.0 | 1.54.8 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-defaults` | 0.17.7 | 0.17.8 | Patch |
| `@backstage/integration` | 2.1.0 | 2.1.1 | Patch |
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.4.19 | 0.4.20 | Patch |
| `@backstage/plugin-auth-node` | 0.7.4 | 0.7.5 | Patch |
| `@backstage/plugin-catalog-backend` | 3.9.0 | 3.9.1 | Patch |
| `@backstage/plugin-catalog-backend-module-aws` | 0.4.26 | 0.4.27 | Patch |
| `@backstage/plugin-catalog-backend-module-azure` | 0.3.20 | 0.3.21 | Patch |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.8.6 | 0.8.7 | Patch |
| `@backstage/plugin-catalog-import` | 0.13.16 | 0.13.17 | Patch |
| `@backstage/plugin-catalog-react` | 3.2.1 | 3.2.2 | Patch |
| `@backstage/plugin-kubernetes-backend` | 0.21.7 | 0.21.10 | Patch |
| `@backstage/plugin-org` | 0.7.7 | 0.7.8 | Patch |
| `@backstage/plugin-proxy-backend` | 0.6.16 | 0.6.17 | Patch |
| `@backstage/plugin-scaffolder-backend` | 4.0.3 | 4.1.0 | Minor |
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.2.24 | 0.2.25 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` | 0.3.9 | 0.3.10 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-server` | 0.2.24 | 0.2.25 | Patch |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.3.24 | 0.3.25 | Patch |
| `@backstage/plugin-scaffolder-backend-module-github` | 0.9.12 | 0.9.13 | Patch |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.11.9 | 0.11.10 | Patch |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.3.7 | 0.3.8 | Patch |
| `@backstage/plugin-scaffolder-common` | 2.2.2 | 2.2.3 | Patch |
| `@backstage/plugin-search-backend` | 2.1.5 | 2.1.6 | Patch |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.8.6 | 1.8.7 | Patch |
| `@backstage/plugin-techdocs-backend` | 2.2.3 | 2.2.5 | Patch |
| `@backstage/plugin-techdocs-node` | 1.15.3 | 1.15.5 | Patch |
| `@techdocs/cli` | 1.11.3 | 1.11.4 | Patch |
...
| `@backstage/integration` | 2.0.3 | 2.1.1 | Minor |
...
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.4.18 | 0.4.20 | Patch |
...
| `@backstage/plugin-auth-node` | 0.7.3 | 0.7.5 | Patch |
...
| `@backstage/plugin-catalog-backend` | 3.8.2 | 3.9.1 | Minor |
| `@backstage/plugin-catalog-backend-module-ai-model` | 0.1.2 | 0.1.3 | Patch |
| `@backstage/plugin-catalog-backend-module-aws` | 0.4.25 | 0.4.27 | Patch |
| `@backstage/plugin-catalog-backend-module-azure` | 0.3.19 | 0.3.21 | Patch |
...
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.8.5 | 0.8.7 | Patch |
...
| `@backstage/plugin-catalog-import` | 0.13.15 | 0.13.17 | Patch |
| `@backstage/plugin-catalog-node` | 2.2.3 | 2.2.4 | Patch |
| `@backstage/plugin-catalog-react` | 3.2.0 | 3.2.2 | Patch |
...
| `@backstage/plugin-kubernetes-backend` | 0.21.6 | 0.21.10 | Patch |
...
| `@backstage/plugin-org` | 0.7.6 | 0.7.8 | Patch |
...
| `@backstage/plugin-proxy-backend` | 0.6.15 | 0.6.17 | Patch |
| `@backstage/plugin-proxy-node` | 0.1.17 | 0.1.18 | Patch |
| `@backstage/plugin-scaffolder` | 1.38.1 | 1.38.2 | Patch |
| `@backstage/plugin-scaffolder-backend` | 4.0.3 | 4.1.0 | Minor |
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.2.23 | 0.2.25 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` | 0.3.8 | 0.3.10 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-server` | 0.2.23 | 0.2.25 | Patch |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.3.23 | 0.3.25 | Patch |
...
| `@backstage/plugin-scaffolder-backend-module-github` | 0.9.11 | 0.9.13 | Patch |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.11.8 | 0.11.10 | Patch |
...
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.3.6 | 0.3.8 | Patch |
...
| `@backstage/plugin-techdocs-backend` | 2.2.2 | 2.2.5 | Patch |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.1.38 | 1.1.39 | Patch |
| `@backstage/plugin-techdocs-node` | 1.15.2 | 1.15.5 | Patch |
...
| `@techdocs/cli` | 1.11.2 | 1.11.4 | Patch |
