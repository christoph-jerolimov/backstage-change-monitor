...
- [0.x patch version bumps](#0x-patch-version-bumps): 45 packages
...
- [Excluded dependency updates](#excluded-dependency-updates): 116 packages
...
### `@backstage/catalog-client` (1.14.0 → [1.15.0](../../changelogs/@backstage/catalog-client.md#1150))
...
### `@backstage/frontend-plugin-api` (0.15.1 → [0.16.0](../../changelogs/@backstage/frontend-plugin-api.md#0160))
...
### `@backstage/plugin-auth-backend` (0.27.3 → [0.28.0](../../changelogs/@backstage/plugin-auth-backend.md#0280))
...
### `@backstage/plugin-catalog-node` (2.1.0 → [2.2.0](../../changelogs/@backstage/plugin-catalog-node.md#220))
...
### `@backstage/plugin-permission-react` (0.4.41 → [0.5.0](../../changelogs/@backstage/plugin-permission-react.md#050))
...
### `@backstage/plugin-signals-node` (0.1.29 → [0.2.0](../../changelogs/@backstage/plugin-signals-node.md#020))
...
### `@backstage/ui` (0.13.3 → [0.14.0](../../changelogs/@backstage/ui.md#0140))
...
### `@backstage/cli-module-actions` (0.0.1 → [0.1.0](../../changelogs/@backstage/cli-module-actions.md#010))
...
### `@backstage/plugin-api-docs` (0.13.5 → [0.14.0](../../changelogs/@backstage/plugin-api-docs.md#0140))
...
### `@backstage/plugin-auth-backend-module-auth0-provider` (0.3.1 → [0.4.0](../../changelogs/@backstage/plugin-auth-backend-module-auth0-provider.md#040))
...
### `@backstage/plugin-signals` (0.0.29 → [0.0.30](../../changelogs/@backstage/plugin-signals.md#0030))
...
### `@backstage/backend-dynamic-feature-service` (0.8.0 → [0.8.1](../../changelogs/@backstage/backend-dynamic-feature-service.md#081))
...
### `@backstage/backend-openapi-utils` (0.6.7 → [0.6.8](../../changelogs/@backstage/backend-openapi-utils.md#068))
...
### `@backstage/cli` (0.36.0 → [0.36.1](../../changelogs/@backstage/cli.md#0361))
...
### `@backstage/cli-common` (0.2.0 → [0.2.1](../../changelogs/@backstage/cli-common.md#021))
...
### `@backstage/cli-module-auth` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-auth.md#011))
...
### `@backstage/cli-module-build` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-build.md#011))
...
### `@backstage/cli-module-migrate` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-migrate.md#011))
...
### `@backstage/cli-module-new` (0.1.1 → [0.1.2](../../changelogs/@backstage/cli-module-new.md#012))
...
### `@backstage/cli-module-test-jest` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-test-jest.md#011))
...
### `@backstage/cli-node` (0.3.0 → [0.3.1](../../changelogs/@backstage/cli-node.md#031))
...
### `@backstage/core-compat-api` (0.5.9 → [0.5.10](../../changelogs/@backstage/core-compat-api.md#0510))
...
### `@backstage/core-components` (0.18.8 → [0.18.9](../../changelogs/@backstage/core-components.md#0189))
...
### `@backstage/create-app` (0.8.1 → [0.8.2](../../changelogs/@backstage/create-app.md#082))
...
### `@backstage/eslint-plugin` (0.2.2 → [0.2.3](../../changelogs/@backstage/eslint-plugin.md#023))
...
### `@backstage/filter-predicates` (0.1.1 → [0.1.2](../../changelogs/@backstage/filter-predicates.md#012))
...
### `@backstage/frontend-app-api` (0.16.1 → [0.16.2](../../changelogs/@backstage/frontend-app-api.md#0162))
...
### `@backstage/plugin-auth` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-auth.md#017))
...
### `@backstage/plugin-catalog-backend-module-azure` (0.3.15 → [0.3.16](../../changelogs/@backstage/plugin-catalog-backend-module-azure.md#0316))
...
### `@backstage/plugin-catalog-backend-module-bitbucket-cloud` (0.5.9 → [0.5.10](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-cloud.md#0510))
...
### `@backstage/plugin-catalog-backend-module-github` (0.13.0 → [0.13.1](../../changelogs/@backstage/plugin-catalog-backend-module-github.md#0131))
...
### `@backstage/plugin-catalog-backend-module-gitlab` (0.8.1 → [0.8.2](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab.md#082))
...
### `@backstage/plugin-catalog-backend-module-incremental-ingestion` (0.7.10 → [0.7.11](../../changelogs/@backstage/plugin-catalog-backend-module-incremental-ingestion.md#0711))
...
### `@backstage/plugin-catalog-graph` (0.6.0 → [0.6.1](../../changelogs/@backstage/plugin-catalog-graph.md#061))
...
### `@backstage/plugin-catalog-import` (0.13.11 → [0.13.12](../../changelogs/@backstage/plugin-catalog-import.md#01312))
...
### `@backstage/plugin-catalog-unprocessed-entities` (0.2.28 → [0.2.29](../../changelogs/@backstage/plugin-catalog-unprocessed-entities.md#0229))
...
### `@backstage/plugin-devtools-backend` (0.5.15 → [0.5.16](../../changelogs/@backstage/plugin-devtools-backend.md#0516))
...
### `@backstage/plugin-events-backend-module-google-pubsub` (0.2.1 → [0.2.2](../../changelogs/@backstage/plugin-events-backend-module-google-pubsub.md#022))
...
### `@backstage/plugin-kubernetes` (0.12.17 → [0.12.18](../../changelogs/@backstage/plugin-kubernetes.md#01218))
...
### `@backstage/plugin-kubernetes-backend` (0.21.2 → [0.21.3](../../changelogs/@backstage/plugin-kubernetes-backend.md#0213))
...
### `@backstage/plugin-mcp-actions-backend` (0.1.11 → [0.1.12](../../changelogs/@backstage/plugin-mcp-actions-backend.md#0112))
...
### `@backstage/plugin-notifications` (0.5.15 → [0.5.16](../../changelogs/@backstage/plugin-notifications.md#0516))
...
### `@backstage/plugin-notifications-backend` (0.6.3 → [0.6.4](../../changelogs/@backstage/plugin-notifications-backend.md#064))
...
### `@backstage/plugin-notifications-backend-module-email` (0.3.19 → [0.3.20](../../changelogs/@backstage/plugin-notifications-backend-module-email.md#0320))
...
### `@backstage/plugin-notifications-backend-module-slack` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-notifications-backend-module-slack.md#041))
...
### `@backstage/plugin-org` (0.7.0 → [0.7.1](../../changelogs/@backstage/plugin-org.md#071))
...
### `@backstage/plugin-org-react` (0.1.48 → [0.1.49](../../changelogs/@backstage/plugin-org-react.md#0149))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` (0.3.4 → [0.3.5](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-cloud.md#035))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-server` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-server.md#0220))
...
### `@backstage/plugin-scaffolder-backend-module-github` (0.9.7 → [0.9.8](../../changelogs/@backstage/plugin-scaffolder-backend-module-github.md#098))
...
### `@backstage/plugin-scaffolder-backend-module-rails` (0.5.19 → [0.5.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-rails.md#0520))
...
### `@backstage/plugin-scaffolder-node` (0.13.1 → [0.13.2](../../changelogs/@backstage/plugin-scaffolder-node.md#0132))
...
### `@backstage/plugin-search-backend-module-pg` (0.5.53 → [0.5.54](../../changelogs/@backstage/plugin-search-backend-module-pg.md#0554))
...
### `@backstage/plugin-search-backend-module-techdocs` (0.4.12 → [0.4.13](../../changelogs/@backstage/plugin-search-backend-module-techdocs.md#0413))
...
### `@backstage/repo-tools` (0.17.0 → [0.17.1](../../changelogs/@backstage/repo-tools.md#0171))
...
### `@backstage/backend-plugin-api` (1.8.0 → [1.9.0](../../changelogs/@backstage/backend-plugin-api.md#190))
...
### `@backstage/catalog-model` (1.7.7 → [1.8.0](../../changelogs/@backstage/catalog-model.md#180))
...
### `@backstage/core-app-api` (1.19.6 → [1.20.0](../../changelogs/@backstage/core-app-api.md#1200))
...
### `@backstage/errors` (1.2.7 → [1.3.0](../../changelogs/@backstage/errors.md#130))
...
### `@backstage/app-defaults` (1.7.6 → [1.7.7](../../changelogs/@backstage/app-defaults.md#177))
...
### `@backstage/backend-app-api` (1.6.0 → [1.6.1](../../changelogs/@backstage/backend-app-api.md#161))
...
### `@backstage/backend-test-utils` (1.11.1 → [1.11.2](../../changelogs/@backstage/backend-test-utils.md#1112))
...
### `@backstage/config-loader` (1.10.9 → [1.10.10](../../changelogs/@backstage/config-loader.md#11010))
...
### `@backstage/integration` (2.0.0 → [2.0.1](../../changelogs/@backstage/integration.md#201))
...
### `@backstage/plugin-catalog` (2.0.1 → [2.0.2](../../changelogs/@backstage/plugin-catalog.md#202))
...
### `@backstage/plugin-catalog-react` (2.1.1 → [2.1.2](../../changelogs/@backstage/plugin-catalog-react.md#212))
...
### `@backstage/plugin-gateway-backend` (1.1.3 → [1.1.4](../../changelogs/@backstage/plugin-gateway-backend.md#114))
...
### `@backstage/plugin-scaffolder` (1.36.1 → [1.36.2](../../changelogs/@backstage/plugin-scaffolder.md#1362))
...
### `@backstage/plugin-scaffolder-react` (1.20.0 → [1.20.1](../../changelogs/@backstage/plugin-scaffolder-react.md#1201))
...
### `@backstage/plugin-search` (1.7.0 → [1.7.1](../../changelogs/@backstage/plugin-search.md#171))
...
### `@backstage/plugin-search-backend-node` (1.4.2 → [1.4.3](../../changelogs/@backstage/plugin-search-backend-node.md#143))
...
### `@backstage/plugin-techdocs` (1.17.2 → [1.17.3](../../changelogs/@backstage/plugin-techdocs.md#1173))
...
### `@backstage/plugin-techdocs-backend` (2.1.6 → [2.1.7](../../changelogs/@backstage/plugin-techdocs-backend.md#217))
...
### `@backstage/plugin-techdocs-node` (1.14.4 → [1.14.5](../../changelogs/@backstage/plugin-techdocs-node.md#1145))
...
### `@techdocs/cli` (1.10.6 → [1.10.7](../../changelogs/@techdocs/cli.md#1107))
...
- `@backstage/cli-defaults` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-defaults.md#011))
- `@backstage/cli-module-config` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-config.md#011))
- `@backstage/cli-module-github` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-github.md#011))
- `@backstage/cli-module-info` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-info.md#011))
- `@backstage/cli-module-lint` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-lint.md#011))
- `@backstage/cli-module-maintenance` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-maintenance.md#011))
- `@backstage/cli-module-translations` (0.1.0 → [0.1.1](../../changelogs/@backstage/cli-module-translations.md#011))
- `@backstage/codemods` (0.1.55 → [0.1.56](../../changelogs/@backstage/codemods.md#0156))
- `@backstage/config` (1.3.6 → [1.3.7](../../changelogs/@backstage/config.md#137))
- `@backstage/core-plugin-api` (1.12.4 → [1.12.5](../../changelogs/@backstage/core-plugin-api.md#1125))
- `@backstage/dev-utils` (1.1.21 → [1.1.22](../../changelogs/@backstage/dev-utils.md#1122))
- `@backstage/frontend-defaults` (0.5.0 → [0.5.1](../../changelogs/@backstage/frontend-defaults.md#051))
- `@backstage/frontend-dev-utils` (0.1.0 → [0.1.1](../../changelogs/@backstage/frontend-dev-utils.md#011))
- `@backstage/frontend-dynamic-feature-loader` (0.1.10 → [0.1.11](../../changelogs/@backstage/frontend-dynamic-feature-loader.md#0111))
- `@backstage/frontend-test-utils` (0.5.1 → [0.5.2](../../changelogs/@backstage/frontend-test-utils.md#052))
- `@backstage/integration-aws-node` (0.1.20 → [0.1.21](../../changelogs/@backstage/integration-aws-node.md#0121))
- `@backstage/integration-react` (1.2.16 → [1.2.17](../../changelogs/@backstage/integration-react.md#1217))
- `@backstage/module-federation-common` (0.1.2 → [0.1.3](../../changelogs/@backstage/module-federation-common.md#013))
- `@backstage/plugin-app-backend` (0.5.12 → [0.5.13](../../changelogs/@backstage/plugin-app-backend.md#0513))
- `@backstage/plugin-app-node` (0.1.43 → [0.1.44](../../changelogs/@backstage/plugin-app-node.md#0144))
- `@backstage/plugin-app-react` (0.2.1 → [0.2.2](../../changelogs/@backstage/plugin-app-react.md#022))
- `@backstage/plugin-auth-backend-module-atlassian-provider` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-auth-backend-module-atlassian-provider.md#0414))
- `@backstage/plugin-auth-backend-module-aws-alb-provider` (0.4.14 → [0.4.15](../../changelogs/@backstage/plugin-auth-backend-module-aws-alb-provider.md#0415))
- `@backstage/plugin-auth-backend-module-azure-easyauth-provider` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-auth-backend-module-azure-easyauth-provider.md#0219))
- `@backstage/plugin-auth-backend-module-bitbucket-provider` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-provider.md#0314))
- `@backstage/plugin-auth-backend-module-bitbucket-server-provider` (0.2.13 → [0.2.14](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-server-provider.md#0214))
- `@backstage/plugin-auth-backend-module-cloudflare-access-provider` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-auth-backend-module-cloudflare-access-provider.md#0414))
- `@backstage/plugin-auth-backend-module-gcp-iap-provider` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-auth-backend-module-gcp-iap-provider.md#0414))
- `@backstage/plugin-auth-backend-module-github-provider` (0.5.1 → [0.5.2](../../changelogs/@backstage/plugin-auth-backend-module-github-provider.md#052))
- `@backstage/plugin-auth-backend-module-gitlab-provider` (0.4.1 → [0.4.2](../../changelogs/@backstage/plugin-auth-backend-module-gitlab-provider.md#042))
- `@backstage/plugin-auth-backend-module-google-provider` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-auth-backend-module-google-provider.md#0314))
- `@backstage/plugin-auth-backend-module-guest-provider` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-auth-backend-module-guest-provider.md#0218))
- `@backstage/plugin-auth-backend-module-microsoft-provider` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-auth-backend-module-microsoft-provider.md#0314))
- `@backstage/plugin-auth-backend-module-oauth2-provider` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-provider.md#0414))
- `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-proxy-provider.md#0219))
- `@backstage/plugin-auth-backend-module-oidc-provider` (0.4.14 → [0.4.15](../../changelogs/@backstage/plugin-auth-backend-module-oidc-provider.md#0415))
- `@backstage/plugin-auth-backend-module-okta-provider` (0.2.13 → [0.2.14](../../changelogs/@backstage/plugin-auth-backend-module-okta-provider.md#0214))
- `@backstage/plugin-auth-backend-module-onelogin-provider` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-auth-backend-module-onelogin-provider.md#0314))
- `@backstage/plugin-auth-backend-module-openshift-provider` (0.1.5 → [0.1.6](../../changelogs/@backstage/plugin-auth-backend-module-openshift-provider.md#016))
- `@backstage/plugin-auth-backend-module-pinniped-provider` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-auth-backend-module-pinniped-provider.md#0313))
- `@backstage/plugin-auth-backend-module-vmware-cloud-provider` (0.5.12 → [0.5.13](../../changelogs/@backstage/plugin-auth-backend-module-vmware-cloud-provider.md#0513))
- `@backstage/plugin-auth-react` (0.1.25 → [0.1.26](../../changelogs/@backstage/plugin-auth-react.md#0126))
- `@backstage/plugin-bitbucket-cloud-common` (0.3.8 → [0.3.9](../../changelogs/@backstage/plugin-bitbucket-cloud-common.md#039))
- `@backstage/plugin-catalog-backend-module-aws` (0.4.21 → [0.4.22](../../changelogs/@backstage/plugin-catalog-backend-module-aws.md#0422))
- `@backstage/plugin-catalog-backend-module-backstage-openapi` (0.5.12 → [0.5.13](../../changelogs/@backstage/plugin-catalog-backend-module-backstage-openapi.md#0513))
- `@backstage/plugin-catalog-backend-module-bitbucket-server` (0.5.9 → [0.5.10](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-server.md#0510))
- `@backstage/plugin-catalog-backend-module-gcp` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-catalog-backend-module-gcp.md#0318))
- `@backstage/plugin-catalog-backend-module-gerrit` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-catalog-backend-module-gerrit.md#0313))
- `@backstage/plugin-catalog-backend-module-gitea` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-catalog-backend-module-gitea.md#0111))
- `@backstage/plugin-catalog-backend-module-github-org` (0.3.20 → [0.3.21](../../changelogs/@backstage/plugin-catalog-backend-module-github-org.md#0321))
- `@backstage/plugin-catalog-backend-module-gitlab-org` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab-org.md#0220))
- `@backstage/plugin-catalog-backend-module-ldap` (0.12.3 → [0.12.4](../../changelogs/@backstage/plugin-catalog-backend-module-ldap.md#0124))
- `@backstage/plugin-catalog-backend-module-logs` (0.1.20 → [0.1.21](../../changelogs/@backstage/plugin-catalog-backend-module-logs.md#0121))
- `@backstage/plugin-catalog-backend-module-msgraph` (0.9.1 → [0.9.2](../../changelogs/@backstage/plugin-catalog-backend-module-msgraph.md#092))
- `@backstage/plugin-catalog-backend-module-openapi` (0.2.20 → [0.2.21](../../changelogs/@backstage/plugin-catalog-backend-module-openapi.md#0221))
- `@backstage/plugin-catalog-backend-module-puppetdb` (0.2.20 → [0.2.21](../../changelogs/@backstage/plugin-catalog-backend-module-puppetdb.md#0221))
- `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-catalog-backend-module-scaffolder-entity-model.md#0219))
- `@backstage/plugin-catalog-backend-module-unprocessed` (0.6.9 → [0.6.10](../../changelogs/@backstage/plugin-catalog-backend-module-unprocessed.md#0610))
- `@backstage/plugin-catalog-common` (1.1.8 → [1.1.9](../../changelogs/@backstage/plugin-catalog-common.md#119))
- `@backstage/plugin-catalog-unprocessed-entities-common` (0.0.13 → [0.0.14](../../changelogs/@backstage/plugin-catalog-unprocessed-entities-common.md#0014))
- `@backstage/plugin-config-schema` (0.1.78 → [0.1.79](../../changelogs/@backstage/plugin-config-schema.md#0179))
- `@backstage/plugin-devtools` (0.1.37 → [0.1.38](../../changelogs/@backstage/plugin-devtools.md#0138))
- `@backstage/plugin-devtools-common` (0.1.23 → [0.1.24](../../changelogs/@backstage/plugin-devtools-common.md#0124))
- `@backstage/plugin-devtools-react` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-devtools-react.md#021))
- `@backstage/plugin-events-backend` (0.6.0 → [0.6.1](../../changelogs/@backstage/plugin-events-backend.md#061))
- `@backstage/plugin-events-backend-module-aws-sqs` (0.4.20 → [0.4.21](../../changelogs/@backstage/plugin-events-backend-module-aws-sqs.md#0421))
- `@backstage/plugin-events-backend-module-azure` (0.2.29 → [0.2.30](../../changelogs/@backstage/plugin-events-backend-module-azure.md#0230))
- `@backstage/plugin-events-backend-module-bitbucket-cloud` (0.2.29 → [0.2.30](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-cloud.md#0230))
- `@backstage/plugin-events-backend-module-bitbucket-server` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-server.md#0111))
- `@backstage/plugin-events-backend-module-gerrit` (0.2.29 → [0.2.30](../../changelogs/@backstage/plugin-events-backend-module-gerrit.md#0230))
- `@backstage/plugin-events-backend-module-github` (0.4.10 → [0.4.11](../../changelogs/@backstage/plugin-events-backend-module-github.md#0411))
- `@backstage/plugin-events-backend-module-gitlab` (0.3.10 → [0.3.11](../../changelogs/@backstage/plugin-events-backend-module-gitlab.md#0311))
- `@backstage/plugin-events-backend-module-kafka` (0.3.2 → [0.3.3](../../changelogs/@backstage/plugin-events-backend-module-kafka.md#033))
- `@backstage/plugin-events-backend-test-utils` (0.1.53 → [0.1.54](../../changelogs/@backstage/plugin-events-backend-test-utils.md#0154))
- `@backstage/plugin-events-node` (0.4.20 → [0.4.21](../../changelogs/@backstage/plugin-events-node.md#0421))
- `@backstage/plugin-home` (0.9.3 → [0.9.4](../../changelogs/@backstage/plugin-home.md#094))
- `@backstage/plugin-home-react` (0.1.36 → [0.1.37](../../changelogs/@backstage/plugin-home-react.md#0137))
- `@backstage/plugin-kubernetes-cluster` (0.0.35 → [0.0.36](../../changelogs/@backstage/plugin-kubernetes-cluster.md#0036))
- `@backstage/plugin-kubernetes-common` (0.9.10 → [0.9.11](../../changelogs/@backstage/plugin-kubernetes-common.md#0911))
- `@backstage/plugin-kubernetes-node` (0.4.2 → [0.4.3](../../changelogs/@backstage/plugin-kubernetes-node.md#043))
- `@backstage/plugin-kubernetes-react` (0.5.17 → [0.5.18](../../changelogs/@backstage/plugin-kubernetes-react.md#0518))
- `@backstage/plugin-mui-to-bui` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-mui-to-bui.md#026))
- `@backstage/plugin-notifications-common` (0.2.1 → [0.2.2](../../changelogs/@backstage/plugin-notifications-common.md#022))
- `@backstage/plugin-notifications-node` (0.2.24 → [0.2.25](../../changelogs/@backstage/plugin-notifications-node.md#0225))
- `@backstage/plugin-permission-backend` (0.7.10 → [0.7.11](../../changelogs/@backstage/plugin-permission-backend.md#0711))
- `@backstage/plugin-permission-backend-module-allow-all-policy` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-permission-backend-module-allow-all-policy.md#0218))
- `@backstage/plugin-permission-common` (0.9.7 → [0.9.8](../../changelogs/@backstage/plugin-permission-common.md#098))
- `@backstage/plugin-permission-node` (0.10.11 → [0.10.12](../../changelogs/@backstage/plugin-permission-node.md#01012))
- `@backstage/plugin-proxy-backend` (0.6.11 → [0.6.12](../../changelogs/@backstage/plugin-proxy-backend.md#0612))
- `@backstage/plugin-proxy-node` (0.1.13 → [0.1.14](../../changelogs/@backstage/plugin-proxy-node.md#0114))
- `@backstage/plugin-scaffolder-backend-module-azure` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-azure.md#0220))
- `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` (0.3.19 → [0.3.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-confluence-to-markdown.md#0320))
- `@backstage/plugin-scaffolder-backend-module-cookiecutter` (0.3.21 → [0.3.22](../../changelogs/@backstage/plugin-scaffolder-backend-module-cookiecutter.md#0322))
- `@backstage/plugin-scaffolder-backend-module-gcp` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-gcp.md#0220))
- `@backstage/plugin-scaffolder-backend-module-gerrit` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-gerrit.md#0220))
- `@backstage/plugin-scaffolder-backend-module-gitea` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitea.md#0220))
- `@backstage/plugin-scaffolder-backend-module-gitlab` (0.11.4 → [0.11.5](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitlab.md#0115))
- `@backstage/plugin-scaffolder-backend-module-notifications` (0.1.20 → [0.1.21](../../changelogs/@backstage/plugin-scaffolder-backend-module-notifications.md#0121))
- `@backstage/plugin-scaffolder-backend-module-sentry` (0.3.2 → [0.3.3](../../changelogs/@backstage/plugin-scaffolder-backend-module-sentry.md#033))
- `@backstage/plugin-scaffolder-backend-module-yeoman` (0.4.20 → [0.4.21](../../changelogs/@backstage/plugin-scaffolder-backend-module-yeoman.md#0421))
- `@backstage/plugin-scaffolder-node-test-utils` (0.3.9 → [0.3.10](../../changelogs/@backstage/plugin-scaffolder-node-test-utils.md#0310))
- `@backstage/plugin-search-backend` (2.1.0 → [2.1.1](../../changelogs/@backstage/plugin-search-backend.md#211))
- `@backstage/plugin-search-backend-module-catalog` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-search-backend-module-catalog.md#0314))
- `@backstage/plugin-search-backend-module-elasticsearch` (1.8.1 → [1.8.2](../../changelogs/@backstage/plugin-search-backend-module-elasticsearch.md#182))
- `@backstage/plugin-search-backend-module-explore` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-search-backend-module-explore.md#0313))
- `@backstage/plugin-search-backend-module-stack-overflow-collator` (0.3.18 → [0.3.19](../../changelogs/@backstage/plugin-search-backend-module-stack-overflow-collator.md#0319))
- `@backstage/plugin-search-common` (1.2.22 → [1.2.23](../../changelogs/@backstage/plugin-search-common.md#1223))
- `@backstage/plugin-search-react` (1.11.0 → [1.11.1](../../changelogs/@backstage/plugin-search-react.md#1111))
- `@backstage/plugin-signals-backend` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-signals-backend.md#0314))
- `@backstage/plugin-signals-react` (0.0.20 → [0.0.21](../../changelogs/@backstage/plugin-signals-react.md#0021))
- `@backstage/plugin-techdocs-addons-test-utils` (2.0.3 → [2.0.4](../../changelogs/@backstage/plugin-techdocs-addons-test-utils.md#204))
- `@backstage/plugin-techdocs-module-addons-contrib` (1.1.34 → [1.1.35](../../changelogs/@backstage/plugin-techdocs-module-addons-contrib.md#1135))
- `@backstage/plugin-techdocs-react` (1.3.9 → [1.3.10](../../changelogs/@backstage/plugin-techdocs-react.md#1310))
- `@backstage/plugin-user-settings` (0.9.1 → [0.9.2](../../changelogs/@backstage/plugin-user-settings.md#092))
- `@backstage/plugin-user-settings-backend` (0.4.1 → [0.4.2](../../changelogs/@backstage/plugin-user-settings-backend.md#042))
- `@backstage/test-utils` (1.7.16 → [1.7.17](../../changelogs/@backstage/test-utils.md#1717))
