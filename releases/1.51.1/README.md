# Backstage Release 1.51.1

## Compared to 1.51.0 (previous patch release)

0 added, 0 removed, 5 upgraded, 204 unchanged.

### Version bumps

| Package | 1.51.0 | 1.51.1 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.10.0 | 0.10.1 | Patch |

## Compared to 1.50.7 (previous minor release)
...
| `@backstage/catalog-client` | 1.15.0 | 1.15.2 | Patch |
...
| `@backstage/frontend-plugin-api` | 0.16.2 | 0.17.1 | Minor ⚠️ |
...
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.9.2 | 0.10.1 | Minor ⚠️ |
...
| `@backstage/plugin-techdocs-node` | 1.14.8 | 1.15.0 | Minor |
